...
root@cloud:~# Connection to 38.147.188.182 closed by remote host.
Connection to 38.147.188.182 closed.
gerchart@Gerchart-ROG-M15:~/.ssh$ ssh HostyunHK
root@38.147.188.182's password:
...
Last login: Mon Jan  8 19:18:35 2024 from 107.175.219.26
root@cloud:~# cat .vimrc
" An example for a vimrc file.
"
" To use it, copy it to
"     for Unix and OS/2:  ~/.vimrc
